	...
	testCases := []framework.RuleTestCase{
		{
			...
			ExpectedFindings: []framework.ExpectedFinding{
				...
				{Message: "I/O resource used without with-open: use with-open to ensure the resource is closed.", StartLine: 23}, //não foi encontrado
				...
				{Message: "I/O resource used without with-open: use with-open to ensure the resource is closed.", StartLine: 45}, //não foi encontrado
			},
		},
	}
