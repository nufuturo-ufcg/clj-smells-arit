...
func (r *DataClumpsRule) Meta() rules.Rule {
	return r.Rule
}

func (r *DataClumpsRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func (d *DataClumpsAnalyzer) GenerateFindings() []*rules.Finding {
	d.mu.Lock()
	defer d.mu.Unlock()
