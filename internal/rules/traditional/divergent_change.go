...
func (r *DivergentChangeRule) Meta() rules.Rule {
	return r.Rule
}

func (r *DivergentChangeRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func (r *DivergentChangeRule) checkFunction(node *reader.RichNode, filepath string) *rules.Finding {
...
func (r *DivergentChangeRule) checkNamespace(node *reader.RichNode, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(NewDivergentChangeRule(nil))
}