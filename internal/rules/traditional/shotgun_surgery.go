...
func (r *ShotgunSurgeryRule) Meta() rules.Rule {
	return r.Rule
}

func (r *ShotgunSurgeryRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(NewShotgunSurgeryRule(nil))
}