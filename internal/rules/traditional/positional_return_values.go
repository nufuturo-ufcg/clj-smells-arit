...
func (r *PositionalReturnValuesRule) Meta() rules.Rule {
	return r.Rule
}
...
func (r *PositionalReturnValuesRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(&PositionalReturnValuesRule{
		Rule: rules.Rule{
