...
func (r *MiddleManRule) Meta() rules.Rule {
	return r.Rule
}

func (r *MiddleManRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(&MiddleManRule{
		Rule: rules.Rule{
			ID:          "middle-man",
