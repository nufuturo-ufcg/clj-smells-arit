...
func (r *LinearCollectionScanRule) Meta() rules.Rule {
	return r.Rule
}

func (r *LinearCollectionScanRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func (r *LinearCollectionScanRule) checkManualLoops(node *reader.RichNode, filepath string) *rules.Finding {
...
func (r *LinearCollectionScanRule) checkChainedOperations(node *reader.RichNode, filepath string) *rules.Finding {
...
func (r *LinearCollectionScanRule) checkInefficient(node *reader.RichNode, filepath string) *rules.Finding {
	funcName := r.getFunctionName(node)
	if funcName == "" {
		return nil
	}
...
func (r *LinearCollectionScanRule) checkRedundant(node *reader.RichNode, filepath string) *rules.Finding {
	funcName := r.getFunctionName(node)
	if funcName == "" {
		return nil
	}
...
func (r *LinearCollectionScanRule) checkComposition(node *reader.RichNode, filepath string) *rules.Finding {
...
func (r *LinearCollectionScanRule) checkThreadingPattern(node *reader.RichNode, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(NewLinearCollectionScanRule())
}
