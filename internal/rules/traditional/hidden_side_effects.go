...
func (r *HiddenSideEffectsRule) Meta() rules.Rule {
	return r.Rule
}

func (r *HiddenSideEffectsRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(NewHiddenSideEffectsRule())
}