...
func (r *CommentsRule) Meta() rules.Rule {
	return r.Rule
}
...
func (r *CommentsRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func (r *CommentsRule) checkComment(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
