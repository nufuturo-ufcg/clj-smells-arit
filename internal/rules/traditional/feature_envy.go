...
func (r *FeatureEnvyRule) Meta() rules.Rule {
	return r.Rule
}

func (r *FeatureEnvyRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func (r *FeatureEnvyRule) createFinding(analysis *CallAnalysis, filepath string, node *reader.RichNode) *rules.Finding {
