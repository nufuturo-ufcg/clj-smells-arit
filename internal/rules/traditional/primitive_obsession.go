...
func (r *PrimitiveObsessionParamsRule) Meta() rules.Rule {
...
func (r *PrimitiveObsessionParamsRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
