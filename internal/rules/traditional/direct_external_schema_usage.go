...
func (r *DirectExternalSchemaUsageRule) Meta() rules.Rule {
	return r.Rule
}

func (r *DirectExternalSchemaUsageRule) Check(node *reader.RichNode, fileContext map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(newDirectExternalSchemaUsageRule())
}