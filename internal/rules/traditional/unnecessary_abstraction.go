...
func (r *UnnecessaryAbstractionRule) Meta() rules.Rule {
	return rules.Rule{
...
func (r *UnnecessaryAbstractionRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func (r *UnnecessaryAbstractionRule) checkSingleUseLetFn(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func (r *UnnecessaryAbstractionRule) checkSimpleDefn(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(&UnnecessaryAbstractionRule{})
}