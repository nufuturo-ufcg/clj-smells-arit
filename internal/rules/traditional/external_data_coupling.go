...
func (r *ExternalDataCouplingRule) Meta() rules.Rule {
	return rules.Rule{
...
func (r *ExternalDataCouplingRule) Check(rootNode *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	...
	rules.RegisterRule(NewExternalDataCouplingRule())
}