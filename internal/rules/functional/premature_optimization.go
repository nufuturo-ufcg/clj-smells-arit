...
func NewPrematureOptimizationRule() rules.RegisteredRule {
	return &PrematureOptimizationRule{}
}

func (r *PrematureOptimizationRule) Meta() rules.Rule {
	return rules.Rule{
...
func (r *PrematureOptimizationRule) Check(node *reader.RichNode, context map[string]interface{}, filepathAlias string) *rules.Finding {
...
func init() {
	...
	rules.RegisterRule(NewPrematureOptimizationRule())
