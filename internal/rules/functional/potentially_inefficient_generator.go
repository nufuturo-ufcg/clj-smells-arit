...
func (r *PotentiallyInefficientGeneratorRule) Meta() rules.Rule {
	return rules.Rule{
...
func (r *PotentiallyInefficientGeneratorRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(&PotentiallyInefficientGeneratorRule{})
}