...
func (r *ExplicitRecursionRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func (r *ExplicitRecursionRule) Meta() rules.Rule {
	return r.Rule
}
