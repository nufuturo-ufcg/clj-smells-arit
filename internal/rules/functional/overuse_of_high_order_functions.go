...
func (r *OveruseOfHighOrderFunctionsRule) Meta() rules.Rule {
	return r.Rule
}

func (r *OveruseOfHighOrderFunctionsRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(NewOveruseOfHighOrderFunctionsRule(nil))
}