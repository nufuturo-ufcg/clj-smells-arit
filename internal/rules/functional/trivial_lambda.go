...
func (r *TrivialLambdaRule) Meta() rules.Rule {
	return r.Rule
}

func (r *TrivialLambdaRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
