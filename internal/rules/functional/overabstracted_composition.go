...
func (r *OverabstractedCompositionRule) Meta() rules.Rule {
...
func (r *OverabstractedCompositionRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func init() {
	rules.RegisterRule(&OverabstractedCompositionRule{})
}