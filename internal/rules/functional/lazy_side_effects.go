...
func (r *LazySideEffectsRule) Meta() rules.Rule {
	return rules.Rule{
...
func (r *LazySideEffectsRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
...
func (r *LazySideEffectsRule) createFinding(node *reader.RichNode, lazyFuncName, funcSource string, filepath string, isInEagerCtx bool) *rules.Finding {
	meta := r.Meta()
