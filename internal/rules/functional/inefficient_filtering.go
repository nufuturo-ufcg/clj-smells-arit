...
func (r *InefficientFilteringRule) Meta() rules.Rule {
	return rules.Rule{
...
func (r *InefficientFilteringRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *rules.Finding {
	...
	checks := []func(*reader.RichNode, string, map[string]bool) *rules.Finding{
...
func (r *InefficientFilteringRule) checkLetBindingPatterns(node *reader.RichNode, filepath string, processedPatterns map[string]bool) *rules.Finding {
	if !r.isLetForm(node) {
		return nil
	}
...
func (r *InefficientFilteringRule) checkBasicFilterPatterns(node *reader.RichNode, filepath string, processedPatterns map[string]bool) *rules.Finding {
	patterns := []struct {
		name       string
...
func (r *InefficientFilteringRule) checkThreadingMacroPatterns(node *reader.RichNode, filepath string, _ map[string]bool) *rules.Finding {
...
func (r *InefficientFilteringRule) checkFirstFilterInBinding(valueNode *reader.RichNode, filepath string, processedPatterns map[string]bool) *rules.Finding {
...
func init() {
	rules.RegisterRule(&InefficientFilteringRule{})
}