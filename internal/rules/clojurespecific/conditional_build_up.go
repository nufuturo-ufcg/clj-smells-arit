...
func (r *ConditionalBuildupRule) Meta() rules.Rule {
	return r.Rule
}
...
func makeConditionalBuildUpFinding(r rules.Rule, letNode *reader.RichNode, filepath, name string, count int) *rules.Finding {
	updateWord := "updates"
	if count == 1 {
		updateWord = "update"
	}
...
func (r *ConditionalBuildupRule) detectLetConditionalBuildUp(letNode *reader.RichNode, filepath string) *rules.Finding {
