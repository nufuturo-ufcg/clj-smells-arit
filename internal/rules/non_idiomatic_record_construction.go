...
func (r *NonIdiomaticRecordConstructionRule) Meta() Rule {
	return r.Rule
}
...
func (r *NonIdiomaticRecordConstructionRule) Check(node *reader.RichNode, context map[string]interface{}, filepath string) *Finding {
